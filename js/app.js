...
App.View.ShoppingCart = Backbone.View.extend({
	...
	defaultMessage : function() {
		...
		this.$el.addClass('empty').html('<tr><td colspan="5">Ingen varer valgt</td></tr>');
...
var defaultItems = [
	{ title: 'Alm. Øl', price: 6.50, url: 'beer' },
	{ title: 'Special Øl', price: 7.50, url: 'beer-special' },
	{ title: 'Sodavand', price: 5.00, url: 'soda' },
	{ title: 'Slik', price: 1.00, url: 'candy' },
	{ title: 'Chips', price: 15.00, url: 'chips' },
	{ title: 'Vin', price : 70.00, url: 'wine' }
];
